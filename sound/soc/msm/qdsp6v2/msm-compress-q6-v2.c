...
#if defined(CONFIG_SND_LGE_EFFECT) || defined(CONFIG_SND_LGE_NORMALIZER) || defined(CONFIG_SND_LGE_MABL)
static int lge_dsp_sound_add_gapless_control(struct snd_soc_platform *platform);
#endif
...
static int msm_compr_probe(struct snd_soc_platform *platform)
{
	 ...
	 */
#if defined(CONFIG_SND_LGE_EFFECT) || defined(CONFIG_SND_LGE_NORMALIZER) || defined(CONFIG_SND_LGE_MABL)
	lge_dsp_sound_add_gapless_control(platform);
#endif
...
static int lge_dsp_sound_add_gapless_control(struct snd_soc_platform *platform)
{
	return snd_soc_add_platform_controls(platform, msm_compr_gapless_controls,
