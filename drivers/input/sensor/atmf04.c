...
#if !defined (CONFIG_SENSOR_ATMF04_2ND) && defined (CONFIG_MACH_MSM8952_B3_ATT_US)
...
#if defined(CONFIG_MACH_MSM8952_B3_ATT_US)
...
#define ATMF04_CRCS_COUNT           150
#else // default
#define ATMF04_CRCS_DUTY_LOW        500
...
static int write_initcode(struct i2c_client *client)
{
	...
	int i = 0; // debugging calibration paused
