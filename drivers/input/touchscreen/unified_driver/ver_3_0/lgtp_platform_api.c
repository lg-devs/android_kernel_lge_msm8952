...
void TouchDisableIrq(void)
{
	...
	//TOUCH_LOG("Interrupt Disabled %d\n", nIrq_num);
}
...
int TouchGetBootMode(void)
{
	...
	#if defined(TOUCH_PLATFORM_MSM8916) || defined(TOUCH_PLATFORM_MSM8939) || defined (TOUCH_PLATFORM_MSM8952)
	{
