...
#define MXT_COMMAND_SELF_DELTA	247
...
struct mxt_platform_data {
	...
	unsigned long vcc_i2c;
	unsigned long vdd_ana;
	unsigned long vcc_dig;
	unsigned long gpio_ldo2;
...
//641t porting E
	...
	struct delayed_work	work_temp_monitor;
