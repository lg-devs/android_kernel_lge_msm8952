...
/*-------------------------------------------------------------------------*/
  ...
  */
  ...
  pSchedContext->McThread = kthread_create(VosMCThread, pSchedContext,
                                           "VosMCThread");
  kthread_bind(pSchedContext->McThread, 0);  // LGE patch for hotspot
  ...
  pSchedContext->TxThread = kthread_create(VosTXThread, pSchedContext,
                                           "VosTXThread");
  kthread_bind(pSchedContext->TxThread, 0); // LGE patch for hotspot
  ...
  pSchedContext->RxThread = kthread_create(VosRXThread, pSchedContext,
                                           "VosRXThread");
  kthread_bind(pSchedContext->RxThread, 0); // LGE patch for hotspot
...
/*-------------------------------------------------------------------------*/
  ...
  kthread_bind(pWdContext->WdThread, 0); // LGE patch for hotspot
