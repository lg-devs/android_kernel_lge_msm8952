...
/* LGE_CHANGE, CST, temporal code for cpp poll fail, TODO: should be removed later */
#define 	msm_camera_io_r	msm_camera_io_r_mb
#define 	msm_camera_io_w	msm_camera_io_w_mb
