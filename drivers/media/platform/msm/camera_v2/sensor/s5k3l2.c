...
static struct msm_sensor_power_setting s5k3l2_power_down_setting[] = {
	{
		.seq_type = SENSOR_CLK,
		.seq_val = SENSOR_CAM_MCLK,
		.config_val = 0,
...
/*LGE add for sequence of power down */
	.power_setting_array.power_down_setting= s5k3l2_power_down_setting,
	.power_setting_array.size_down = ARRAY_SIZE(s5k3l2_power_down_setting),
/*LGE add for sequence of power down */
