...
static struct msm_sensor_power_setting ov5670_power_down_setting[] = {
	{
		.seq_type = SENSOR_CLK,
		.seq_val = SENSOR_CAM_MCLK,
		.config_val = 0,
...
/*LGE add for sequence of power down */
	.power_setting_array.power_down_setting= ov5670_power_down_setting,
	.power_setting_array.size_down = ARRAY_SIZE(ov5670_power_down_setting),
/*LGE add for sequence of power down */
