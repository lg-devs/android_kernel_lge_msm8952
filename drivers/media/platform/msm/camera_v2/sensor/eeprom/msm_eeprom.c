...
static uint8_t msm_eeprom_vendor_id(struct msm_eeprom_ctrl_t *e_ctrl) {
	uint8_t eeprom_vendor = e_ctrl->cal_data.mapdata[MODULE_VENDOR_ID];
...
static int msm_eeprom_platform_probe(struct platform_device *pdev)
{
	...
	/* LGE_CHANGE_E, Add CRC check code for AAT camera , 2016-01-08, dongsu.bag@lge.com */
	/* LGE_CHANGE_S, camera id, 2015-04-07, byungsoo.moon@lge.com */
		main_sensor_id = msm_eeprom_vendor_id(e_ctrl);
