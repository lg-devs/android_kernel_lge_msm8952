...
ifeq ($(PRODUCT_SUPPORT_OTG), y)
    KERNEL_CONFIG_OVERRIDE := CONFIG_USB_HOST_NOTIFY=y
endif
...
ifeq ($(PRODUCT_SUPPORT_EXFAT), y)
	...
	@sh tuxera_update.sh --target target/lg.d/mobile-msm8952-3.10.84 --use-cache --latest --max-cache-entries 2 --source-dir $(ANDROID_BUILD_TOP)/kernel --output-dir $(ANDROID_BUILD_TOP)/$(KERNEL_OUT) -a --user lg-mobile --pass AumlTsj0ou
	@tar -xzf tuxera-*.tgz
