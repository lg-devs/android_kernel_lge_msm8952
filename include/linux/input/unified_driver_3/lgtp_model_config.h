...
#define TOUCH_GPIO_POWER_VDDIO 		(128+890) // 1.8
#define TOUCH_GPIO_POWER_AVDD 		(97+890)  // 3.3

#define TOUCH_IRQ_FLAGS (IRQF_TRIGGER_HIGH | IRQF_ONESHOT )
...
extern TouchDeviceSpecificFunction LR388K5_Func;
#endif

#if defined(TOUCH_DEVICE_LR388K6)
extern TouchDeviceSpecificFunction LR388K6_Func;
#endif
